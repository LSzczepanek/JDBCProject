...
public class DBTablePrinter {
    ...
    public static void printTable(Connection conn, String tableName){
        printTable(conn, tableName, "SELECT *",DEFAULT_MAX_ROWS, DEFAULT_MAX_TEXT_COL_WIDTH);
    }
    
    
    
    
    public static void printTable(Connection conn, String tableName, String sqlCommand){
        printTable(conn, tableName, sqlCommand,DEFAULT_MAX_ROWS, DEFAULT_MAX_TEXT_COL_WIDTH);
    }
     ...
     */
    public static void printTable(Connection conn, String tableName, String sqlCommand, int maxRows) {
        printTable(conn, tableName, sqlCommand, maxRows, DEFAULT_MAX_TEXT_COL_WIDTH);
    }
     ...
     */
    public static void printTable(Connection conn, String tableName, String sqlCommand, int maxRows, int maxStringColWidth) {
        if (conn == null) {
        ...
        try {
            ...
            String sqlSelectAll = sqlCommand;//"SELECT * FROM " + tableName;// + " LIMIT " + maxRows;
